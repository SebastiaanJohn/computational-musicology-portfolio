...
As shown on the plot, most of the tracks on the *ye* album are low in energy and valence, which makes sense when you consider it's about his mental health. On the contrary, *Watch the Throne*, the collaboration album with rapper *Jay-Z*, has higher energy and valence scores. Additionally, there seem to be some outliers, such as *Donda Chant* and *All Of The Lights,* which have extremely low energy scores. Furthermore, *I Love Kanye* has a very high valence score. Finally, the track *homecoming* has both extremely high valence and energy scores. All those tracks are exciting candidates to analyze further to see what features make these scores so high. We will do this in the following sections.
...
The plot on the left shows the average tempo in beats per minute (bpm) of Kanye West's albums ranked from highest to lowest. The graph shows that *Yeezus* has the highest tempo with an average of 131 bpm. *Yeezus* having the highest tempo is no surprise. What is a surprise is that the album *ye* has the second-highest bpm. The album feels slower than most of his albums, especially *Graduation*. Thus it is an interesting candidate to examine further. In addition, the next slide will review *Yeezus* to see if any outliers give this album such a high bpm.
