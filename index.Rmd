...
We must determine the essential features of what makes a Kanye West album before we can train a KNN model. We can use a random forest model for this task. The results of the model are shown on the plot on the left. We see that valance is the most critical feature in classifying an album. Looking back at the first plot of this analysis that showed the valance score between albums, this seems fitting, as there was a steady decline from his first album to his last. Loudness appears like a decent feature as well, being the second most important. 
...
The subject of this portfolio is the discography of the rapper, producer, and fashion designer Kanye West, now also formally known as Ye. The choice of Kanye West for this project was an easy one for me. He is arguably one of the greatest hip-hop artists of this generation, and his influence on the music industry can't be understated. In particular, the way he keeps reinventing himself and his musical style (and with it the industry) from his first studio album, "_The College Dropout,"_ to his latest works of _Donda_ and _Jesus is King._ 

#### **Discography**

**The College Dropout** is Kanye's first studio album, released on February 10, 2004. It has received critical acclaim, with many music critics praising West's production skills and provocatively positive lyrics. The album has been cited as one of the greatest hip-hop albums of all time.

**Late Registration** is the second studio album released on August 30, 2005. The album features some of Kanye West's most iconic songs, including "Gold Digger," "Touch the Sky," and "Heard 'Em Say." Overall, the album is a masterful blend of West's signature beats and honest lyrics, and it remains one of his most popular releases to date.

Kanye's third studio album, **Graduation**, was released on September 11, 2007. Graduation featured a more pop-oriented sound than West's previous albums and was acclaimed for its experimental production. It was a critical and commercial success, solidifying Kanye West as one of the biggest names in music.

**808s & Heartbreak** is his fourth studio album, released on November 24, 2008. The album was a radical departure from his previous work, with West incorporating elements of R&B and synth-pop into his signature hip-hop sound. The album was also notable for its deeply personal lyrics, which were inspired by the death of Kanye's mother and the end of his engagement.
...
1.  Kanye West, Sunday Service Choir - Every Hour (Jesus is King): A big departure from previous work. Jesus is King is a gospel album, with the first track _Every Hour_ being in a very different style than done before.
...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/4iz9lGMjU1lXS51oPmUmTe?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
*** 
We saw that the track _Donda Chant_ is one of the most significant outliers of Kanye West's discography. Therefore it will be interesting to see what makes it so distinct from the rest of the songs. The plot on the left shows a chordogram of the track. The most striking point of the graph is the dark area, from 20 seconds to around 43 seconds. There is a significant change in the song in that area that you can immediately notice when listening to the track. The track consists of solely female vocals that say the name _Donda_ repeatedly. This undoubtedly is the reason why it is such an outlier. Regardless, in the dark area, the pronunciation of the name _Donda_ gets a lot slower, which results in the darker area on the chordogram. These experimental tracks are one of the reasons that Kanye's sound is unique.

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/3xQTo7wPYHZtFbHAoygz2c?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
As we saw previously, Kanye West had a significant transformation in music style since the start of his career. Hence, comparing a relatively new song with older work would be interesting. The following four plots show chroma and timbre-based self-similarity matrices of the songs _Through the Wire,_ from the 2004 album The College Dropout, and _Praise God_, from the 2021 album _Donda._ Listening to both songs, it is immediately apparent that they are very different in style. _Through the Wire_ sounds a lot cheerfuller than the more dark tone of _Praise God_.

TODO: add plot details and conclusion
...
<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/32ZGcotUVtU3Zfz9lmM8Mi?utm_source=generator" width="100%" height="80" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
...
plt <- ggplot(
  album_tempo,
  aes(
    x = reorder(album_name, -mean_tempo),
    y = mean_tempo)) +
  geom_bar(stat='identity') +
...
The plot on the left shows the average tempo in beats per minute (bpm) of Kanye West's albums ranked from highest to lowest. The graph shows that _Yeezus_ has the highest tempo with an average of 131 bpm. _Yeezus_ having the highest tempo is no surprise. What is a surprise is that the album _ye_ has the second-highest bpm. The album feels slower than most of his albums, especially _Graduation_. Thus it is an interesting candidate to examine further. In addition, the next slide will review _Yeezus_ to see if any outliers give this album such a high bpm.

<iframe style="border-radius:12px" src="https://open.spotify.com/embed/album/7D2NdGvBHIavgLhmcwhluK?utm_source=generator" width="100%" height="380" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
